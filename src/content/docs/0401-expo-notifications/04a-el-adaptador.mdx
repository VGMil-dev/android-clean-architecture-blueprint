...
- 🔧 <Highlight>Configura</Highlight> cómo se comportan las notificaciones (sonido, alertas).
- 🤖 <Highlight variant="purple">Configura canales</Highlight> de Android (vibración, color de LED).
- 👮‍♀️ <Highlight variant="blue">Gestiona los Permisos</Highlight> del Sistema Operativo.
- 🎟️ <Highlight variant="green">Obtiene el Token</Highlight> único de Expo.

...
> <Highlight variant="blue">Token (Dispositivo)</Highlight> + <Highlight variant="purple">Sesión (Usuario)</Highlight> = <Highlight variant="green">Notificación Personalizada ✅</Highlight>
